...
include { FASTQ_FIND_MIRNA_MIRDEEP2        } from '../subworkflows/nf-core/fastq_find_mirna_mirdeep2'
// local subworkflows
...
workflow NFCORE_SMRNASEQ {
    ...
    if (has_fasta){
        ...
        // Prepare input channels for mirdeep2
        ...
        ch_bowtie_index = ch_bowtie_index
                .map { index ->
                    [[id: 'genome'], index]
                }
